...
DATABASES = {
    'default': {
        ...
        'NAME': 'pvoytko_gguru',                      # Or path to database file if using sqlite3.
        'USER': 'pvoytko',
        'PASSWORD': 'zQB5NDos',
...
# Чтобы ошибки Джанги при валидации форм были по-русски
LANGUAGE_CODE = 'ru-RU'
...
SECRET_KEY = '06v$xcw8(ybtzp=qq1%&o1!$59ewtp-6=27!nxuj%!==#@jkgc'
...
ROOT_URLCONF = 'gguru.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'gguru.wsgi.application'
